    ...
    <div className="footer-content">
      ...
      <div className="footer-section">
        ...
        <div className="social-icons">
          ...
          <a href="https://wa.me/919100009907" target="_blank" rel="noopener noreferrer" className="social-link whatsapp" title="WhatsApp">
            <div className="social-icon-wrap">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="social-link facebook" title="Facebook">
            <div className="social-icon-wrap">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
