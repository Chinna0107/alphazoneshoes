...
const faqs = [
  { question: 'What categories does AlphaZOne offer?', answer: 'AlphaZOne offers premium sandals, shoes, slippers, tshirts, and night pants — all carefully curated for style and comfort.' },
  ...
  return (
    <div className="faq-page">
      <div className="faq-container">
        ...
        <p className="faq-subtitle">Everything you need to know about AlphaZOne</p>
